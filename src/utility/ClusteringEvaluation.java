...
public class ClusteringEvaluation
{
    ...
    public ClusteringEvaluation(Cluster[] clustering, Classification classification)
    {
        ...
        {
            nObjects += clustering[i].getObjects().size();
        }
    }
    ...
    public double computePrecision()
    {
        ...
        for(int i=0 ; i<localPrecision.length ; i++)
        {
            ...
            for (int j=0 ; j<objects.size() ; j++)
            {
                ...
                localPrecision[i][e.getClassLabelID()] += 1.0/objects.size();
            }
        }
    ...
    public double computeRecall()
    {
        ...
        for(int i=0 ; i<localRecall.length ; i++)
        {
            ...
            {
                Entry e = objects.get(j);
                localRecall[i][e.getClassLabelID()] += 1.0/classification.getNumberOfObjectsInClass(e.getClassLabelID());
            }
        }
